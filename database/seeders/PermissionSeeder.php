...
// Hapus Role Lama (Pembersihan)
        ...
        $roleTataUsaha->syncPermissions(['akses_dashboard', 'akses_meja_kontrol', 'akses_monitoring_kehadiran', 'akses_laporan', 'akses_master_guru', 'akses_master_jabatan', 'akses_master_pelajaran', 'akses_master_kelas', 'akses_riwayat_mutasi', 'akses_pengumuman', 'akses_master_siswa', 'akses_penempatan_siswa', 'akses_pembayaran', 'akses_absen_siswa', 'akses_laporan_siswa', 'akses_input_nilai', 'akses_agenda', 'akses_batas_pelajaran', 'akses_pabrik_barcode', 'akses_honor']);
