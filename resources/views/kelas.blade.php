...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden overflow-x-auto max-w-4xl">
            ...
            @if(isset($kelas) && count($kelas) > 0)
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium space-x-1 flex justify-center">
                        <button onclick="bukaModalEdit({{ $k->id }}, '{{ $k->nama_kelas }}')" title="Edit Kelas" class="w-8 h-8 rounded-full bg-orange-50 text-orange-400 hover:bg-orange-400 hover:text-white transition flex items-center justify-center">
