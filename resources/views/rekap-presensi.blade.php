...
<div class="max-w-md mx-auto h-[100dvh] bg-slate-50 flex flex-col relative font-sans overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 right-0 z-40 w-full bg-white/95 backdrop-blur-xl border-t border-slate-100 shadow-[0_-10px_25px_rgba(0,0,0,0.06)] px-4 py-2 flex justify-between items-end pb-safe pt-2">
        ...
        <a href="/rekap-presensi" class="flex flex-col items-center justify-center w-12 text-emerald-600 pb-1 group"><i class="fas fa-file-invoice text-xl mb-1 group-active:scale-90 transition-transform"></i><span class="text-[9px] font-black">Rekap</span></a>
