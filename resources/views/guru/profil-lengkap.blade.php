...
<div data-turbo="true" class="max-w-md mx-auto h-[100dvh] bg-slate-50 flex flex-col relative font-sans overflow-hidden">
    ...
    <div class="shrink-0 bg-white border-b border-slate-100 px-4 py-4 flex items-center relative z-20">
        ...
        <div class="flex-1 px-3">
            ...
            <p class="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mt-0.5">Lengkapi Data Profesional</p>
        </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto bg-slate-50 relative z-10 pb-28 pt-5 scrollbar-none px-5">
        ...
        <form action="{{ route('guru.profil.update') }}" method="POST" id="form-profil">
            ...
            <!-- SECTION 1: DATA UTAMA (Read-only) -->
            <div class="bg-white p-5 rounded-3xl border border-slate-100 shadow-[0_4px_18px_-10px_rgba(2,6,23,0.06)] mb-4">
                ...
                <div class="space-y-3.5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="{{ $guru->nama_guru }}" readonly class="w-full bg-slate-50 border border-slate-100 text-slate-500 font-bold rounded-2xl pl-11 pr-3 py-3 text-sm outline-none cursor-not-allowed">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="{{ $guru->nig }}" readonly class="w-full bg-slate-50 border border-slate-100 text-slate-500 font-bold rounded-2xl pl-11 pr-3 py-3 text-sm outline-none cursor-not-allowed">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-3.5">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" value="{{ $guru->tempat_lahir ?? '' }}" placeholder="Contoh: Surabaya" class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl px-3.5 py-3 text-sm font-medium outline-none transition-all">
                        </div>
                        <div>
                            <label class="block text-[10px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" value="{{ $guru->tanggal_lahir ?? '' }}" class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl px-3.5 py-3 text-sm font-medium outline-none transition-all">
                        </div>
                    </div>

                    <div>
                        <label class="block text-[10px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Jenis Kelamin</label>
                        <select name="gender" class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl px-3.5 py-3 text-sm font-medium outline-none transition-all appearance-none">
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="2" placeholder="Masukkan alamat lengkap..." class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl px-3.5 py-3 text-sm font-medium outline-none transition-all resize-none">{{ $guru->alamat ?? '' }}</textarea>
                    </div>
                </div>
            </div>

            <!-- SECTION 3: KONTAK & AKADEMIK -->
            <div class="bg-white p-5 rounded-3xl border border-slate-100 shadow-[0_4px_18px_-10px_rgba(2,6,23,0.06)] mb-2">
                ...
                <div class="space-y-3.5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="no_hp" value="{{ $guru->no_hp ?? '' }}" placeholder="08xxxxxxxxxx" class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl pl-11 pr-3 py-3 text-sm font-medium outline-none transition-all">
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Pendidikan Terakhir</label>
                        <input type="text" name="pendidikan_terakhir" value="{{ $guru->pendidikan_terakhir ?? '' }}" placeholder="Contoh: S1 Pendidikan Agama Islam" class="w-full bg-white border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 rounded-2xl px-3.5 py-3 text-sm font-medium outline-none transition-all">
                    </div>
                </div>
            </div>
