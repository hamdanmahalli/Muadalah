<div class="shrink-0 z-40 w-full bg-white/95 backdrop-blur-xl border-t border-slate-100 shadow-[0_-10px_25px_rgba(0,0,0,0.06)] px-4 py-2 flex justify-between items-end pb-safe pt-2">
    <a href="/dashboard-guru" class="flex flex-col items-center justify-center w-12 text-slate-400 hover:text-emerald-500 transition pb-1 {{ ($active ?? '') === 'beranda' ? 'text-emerald-600' : '' }} group">
    ...
    <a href="/kaldik" class="flex flex-col items-center justify-center w-12 text-slate-400 hover:text-emerald-500 transition pb-1 {{ ($active ?? '') === 'kaldik' ? 'text-emerald-600' : '' }} group">
    ...
    <a href="/rekap-presensi" class="flex flex-col items-center justify-center w-12 text-slate-400 hover:text-emerald-500 transition pb-1 {{ ($active ?? '') === 'rekap' ? 'text-emerald-600' : '' }} group">
    ...
    <a href="/menu" class="flex flex-col items-center justify-center w-12 text-slate-400 hover:text-emerald-500 transition pb-1 {{ ($active ?? '') === 'menu' ? 'text-emerald-600' : '' }} group">
