{{-- Bagian formulir gabungan: Data Dasar Master Guru + Kelengkapan Data.
     CATATAN: bagian Dokumen dipisah ke partial tersendiri (guru-kelengkapan-dokumen)
     agar di-render DI LUAR form utama (mencegah form bersarang / nested form).
     Variabel: $guru, $editable, $isAdmin, $jabatans (opsional), $guruPage, $bolehDokumen. --}}
@php
    $kelClass = $editable
