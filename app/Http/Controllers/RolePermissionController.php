...
class RolePermissionController extends Controller
{
    public function index()
    {
        ...
        $labelMenu = [
            ...
            'akses_honor_konfigurasi' => 'Honor — Konfigurasi Tarif',
            'akses_honor_proses' => 'Honor — Proses & Rekap (Hitung, Edit Draft)',
            'akses_honor_final' => 'Honor — Finalisasi / Buka Kembali (Only Admin)',
            'akses_honor_scan' => 'Honor — Scan Penerimaan',
